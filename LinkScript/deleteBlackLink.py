...
class deleteBlackLink():
    ...
    def deleteUser(self):
        ...
        """
        # set url
        urldeleteUser = self.scheme+"://" + self.host + '/api/v2/black/delete/'
            ...
            if info['code'] == 200:
                ...
                if info['code'] == 200:
                    ...
                    for id in range(self.start, self.end + 1):
                        ...
                        if info['code'] == 200:
                            i += 1
                            print("删除黑名单id(" + str(id) + ")成功—total：" + str(i))
                        if i == self.total:
                            break;
                        time.sleep(0.1)
                    print("总删除黑名单：" + str(i) + '个')
...
if __name__ == "__main__":
    ...
    if int(end) >= int(start):
        obj = deleteBlackLink(base, host, account, password, int(start), int(end), int(total))
        obj.deleteUser()
    else:
