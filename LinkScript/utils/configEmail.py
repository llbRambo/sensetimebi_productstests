...
class Email:
    def __init__(self):
        ...
        self.subject = Header("SenseLink_API接口测试报告" + " " + date, 'utf-8')
    ...
    def config_content(self):
        ...
        :return:
        """
        f = open(os.path.join(utils_funcs.testFile_path, 'emailStyle.txt'), encoding='UTF-8')
        content = f.read()
        f.close()
    ...
    def config_image(self):
        ...
        """
        # defined image path
        image1_path = os.path.join(utils_funcs.testFile_path, 'images', 'st1.png')
        ...
        image2_path = os.path.join(utils_funcs.testFile_path, 'images', 'st2.png')
    ...
    def config_file(self):
        ...
        if self.check_file():
            ...
            zippath = os.path.join(utils_funcs.senselinkapi_path, "result", "SenseLink_result.zip")
            ...
            filehtml['Content-Disposition'] = 'attachment; filename="SenseLink_result.zip"'
