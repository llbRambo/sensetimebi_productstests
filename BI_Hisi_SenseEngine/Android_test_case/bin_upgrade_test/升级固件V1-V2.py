...
if __name__ == '__main__':
    ip = "10.9.66.24:8888"
    bin_name1 = 'm20_V2.4.3_update_tar.bin'
    bin_name2 = 'm20_V2.5.0_update_tar.bin'
    test_max = 500
    uvc_flag1 = True
    flag_bin = True
    ...
    for i in range(1, test_max+1):
        ...
        if flag_bin:
            D.upgradetime(i, upload_fail_paths, upgrade_interface_screenshot_name, bin_name1)
            flag_bin = False
        else:
            D.upgradetime(i, upload_fail_paths, upgrade_interface_screenshot_name, bin_name2)
            flag_bin = True
